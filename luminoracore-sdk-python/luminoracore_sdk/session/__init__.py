...
from .storage import SessionStorage, create_storage, OptimizedStorageWrapper
...
__all__ = [
    ...
    "MemoryManagerV11",
    "SessionStorage",
    "create_storage",  # NUEVO: Export create_storage
    "OptimizedStorageWrapper",  # NUEVO: Export OptimizedStorageWrapper
    "StorageV11Extension",
    "InMemoryStorageV11",
