...
# Note: Core imports are done conditionally in methods that need them
# This avoids requiring Core to be installed for basic provider functionality
        ...
        **kwargs
        ...
        try:
            ...
            try:
                ...
                HAS_CORE = False
                raise ProviderError("Core components not available. Install luminoracore>=1.2.0")
            
            # Load personality from Core
            personality = CorePersonality(personality_data)
            ...
            raise ProviderError(f"Core components not available. Install luminoracore>=1.2.0: {e}")
        except Exception as e:
